...
from Functions.dataframe_functions import get_bluereport_pdf_dataframe


bluereport_pdf_files = get_bluereport_pdf_dataframe(EXCEL_FILE_PATH_RAW)
bluereport_pdf_files['Tonalität'] = bluereport_pdf_files['Tonalität'].str.lower()
bluereport_pdf_files = bluereport_pdf_files.sort_values(by='Tonalität')
